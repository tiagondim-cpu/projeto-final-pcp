...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 1 - Demanda mensal do ano de planejamento.}]{figuras/fig01_demanda.png}}
...
renderiza com os resultados). Os artefatos públicos e funcionais são:

\begin{itemize}
\tightlist
\item
  \textbf{Repositório (código completo):}
  https://github.com/tiagondim-cpu/projeto-final-pcp
\item
  \textbf{Notebook executado (HTML):}
  https://tiagondim-cpu.github.io/projeto-final-pcp/reports/projeto\_pcp.html
\item
  \textbf{Dashboard interativo:}
  https://projeto-final-pcp-yabzy3maf2syfts8riegnk.streamlit.app/
\end{itemize}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 2 - Backtest: previsão vs real no holdout.}]{figuras/fig02_backtest.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 3 - Plano agregado misto: produção vs demanda, com estoque.}]{figuras/fig03_plano_misto.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 4 - Decomposição de custo e trajetória de estoque por estratégia.}]{figuras/fig04_cenarios.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 5 - Trajetória da força de trabalho por estratégia.}]{figuras/fig05_forca_trabalho.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 6 - Preço-sombra da capacidade regular por mês.}]{figuras/fig06_precos_sombra.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 7 - Tornado de sensibilidade do custo ótimo.}]{figuras/fig07_tornado.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 8 - Fronteira custo × nível de serviço.}]{figuras/fig08_fronteira.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 9 - Distribuição de custo e de nível de serviço realizados (2.000 cenários).}]{figuras/fig09_montecarlo.png}}
